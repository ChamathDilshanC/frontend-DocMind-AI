...
export function TypingAnimation({
  ...
  useEffect(() => {
    ...
    prevSourceRef.current = animationSourceKey
    // Streamed chat text grows token by token; restarting from zero on every new
    // token would flicker, so only reset when the text is replaced, not extended.
    if (animationSourceKey.startsWith(previousSource)) return
    setDisplayedText("")
